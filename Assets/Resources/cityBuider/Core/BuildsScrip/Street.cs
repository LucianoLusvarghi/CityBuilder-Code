...
public class Street : BasicBuilds, Interface_Save {
  ...
  void Start () {
    ...
    base.Game_Manager.mapSys.AddPath(new Vector2Int((int)transform.position.x, (int)transform.position.z));
    ...
    //Save data config
    {
      saveData_ = new SaveDataStructure {
        ...
        prefab = "cityBuider/Placeables/street",
  ...
  public void OnDestroy() {
    ...
    base.Game_Manager.mapSys.LessPath(new Vector2Int((int)transform.position.x, (int)transform.position.z));
